-- Insérer des Classes
INSERT INTO Classe (LibCla, NbEtu) VALUES ('3OLEN', 15), ('4OLEN', 20), ('5OLEN', 16);
...
('tuteur', 'password', '0452634152', 'tuteur@gmail.com','TUTEUR', 'Test', NULL, '6 rue Marechal Leclerc', '38220', 'Grenoble', 2, NULL, 2, NULL, NULL, NULL, NULL, 2, NULL),
('hzenasni', 'password', '0712345678', 'hzenasni.pro@gmail.com', 'ZENASNI', 'Hakim', 1, '24 rue de Lyon', '69800', 'Saint-Priest', NULL, NULL, NULL, 1, 1, 3, 1, 1, 2),
...
('Bilan semestre 1', 15.0, 'Très bon semestre, continuez !', 18.8, 16.5, '2024-09-02', 3),
('Bilan semestre 1', 16.4, 'Rien à dire', 20, 17.5, '2024-09-02', 4),
('Bilan semestre 1', 15.0, 'Très bien', 18.8, 15.0, '2024-09-02', 5),
('Bilan semestre 1', 15.0, 'Continuez ainsi !', 19.5, 16.7, '2024-09-02', 6);

INSERT INTO Bilan2 (LibBilDeux, NotBilDeux, NotOra2, SujBil, DatBil2, IdUti) VALUES
('Bilan semetre 2', 13.6, 14.2, 'Le repas', '2025-01-16', 3),
('Bilan semetre 2', 13.0, 13.2, 'Le repas', '2025-01-16', 4),
('Bilan semetre 2', 14.6, 14.0, 'Les intelligences artificielles', '2025-01-16', 5),
('Bilan semetre 2', 12.9, 16.2, 'Les intelligences artificielles', '2025-01-16', 6);
